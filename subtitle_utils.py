...
def generate_ass_file(words, grouped_captions, ass_path, subtitle_offset=-0.15):
    """
    ...
    with open(ass_path, "w", encoding="utf-8") as f:
        ...
        f.write("[V4+ Styles]\n")
        f.write("Format: Name, Fontname, Fontsize, PrimaryColour, OutlineColour, BackColour, Bold, Italic, Alignment, Outline, Shadow, MarginV\n")
        # PrimaryColour: White (&HFFFFFF&), OutlineColour: Black (&H000000&), Outline=4, MarginV=220
        # Fontname: Impact, Fontsize: 56
        f.write("Style: Default,Impact,56,&HFFFFFF&,&H000000&,&H000000&,&H000000&,1,0,2,4,0,220\n\n")
        ...
        for group in grouped_captions:
            ...
            if not group_words:
                f.write(f"Dialogue: 0,{to_ass_timestamp(max(0.0, group_start + subtitle_offset))},{to_ass_timestamp(max(0.0, group_end + subtitle_offset))},Default,,0,0,0,,{group_text_raw}\n")
                continue
